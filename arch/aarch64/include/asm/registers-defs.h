...
#define SCTLR_EL1_MMU_VALUE (SCTLR_EL1_VALUE | SCTLR_EL1_MMU_ENABLED | BIT(12) | BIT(2) | BIT(1))
...
#define TCR_EL1_TG1_4K BIT(31)
#define HACK (BIT(13) | BIT(12) | BIT(10) | BIT(8) | BIT(29) | BIT(28) | BIT(26) | BIT(24))
#define TCR_EL1_VALUE (TCR_EL1_T0SZ | TCR_EL1_T1SZ | TCR_EL1_TG0_4K | TCR_EL1_TG1_4K | HACK)

#endif  // !ARCH_AARCH64_ASM_REGISTERS_DEFS_H
