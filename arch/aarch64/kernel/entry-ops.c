...
void entry_handle_invalid_ex(const uint8_t type) {
  ...
  print(
      ...
      /* SPSR = */ spsr,
      /* N = */ REGISTERS_PSTATE_SELECT_N(spsr),
      /* Z = */ REGISTERS_PSTATE_SELECT_Z(spsr),
      /* C = */ REGISTERS_PSTATE_SELECT_C(spsr),
      /* V = */ REGISTERS_PSTATE_SELECT_V(spsr),
      /* D = */ REGISTERS_PSTATE_SELECT_D(spsr),
      /* A = */ REGISTERS_PSTATE_SELECT_A(spsr),
      /* I = */ REGISTERS_PSTATE_SELECT_I(spsr),
      /* F = */ REGISTERS_PSTATE_SELECT_F(spsr),
      /* SPSel = */ REGISTERS_PSTATE_SELECT_SPSEL(spsr),
      /* PAN = */ REGISTERS_PSTATE_SELECT_PAN(spsr),
      /* UAO = */ REGISTERS_PSTATE_SELECT_UAO(spsr));
}
